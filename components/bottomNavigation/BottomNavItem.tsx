...
const BottomNavItem: React.FC<BottomNavItemType> = ({onClick, selected, Icon}) => {
    return (
        <div 
            onClick={() => onClick()}
            className={`group flex cursor-pointer ${selected ? "text-white bg-red-700 hover:bg-red-800" : "text-red-700 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"} rounded-2xl h-full w-full items-center justify-center`}>
