...
export const MoreInfo: React.FC<MoreInfoProps> = ({ data, itemPrefixContent, className }) => {
  return (
    <div className="mt-4 flex w-full flex-col space-y-2 xl:w-3/4 2xl:w-1/2">
...
const MoreInfoItem: React.FC<MoreInfoItemProps> = ({
  ...
  return (
    <ul className={cn("flex items-center space-x-2", className)}>
      ...
      <Button
        variant="link"
        className="text-surface-foreground hover:bg-surface-variant/20 w-full justify-start gap-2"
      >
